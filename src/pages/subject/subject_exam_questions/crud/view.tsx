...
const SubjectExamQuestionView: React.FC = (): JSX.Element => {
      ...
      <HeaderExtraLayout
        ...
        btn={
          <div>
            ...
            { checkPermission("test_update") ? ( <Button onClick={() => { navigate(`/subject/exam-questions/update/${id}`) }} > {t("Edit")}</Button>) : null }
          </div>
        }
      />
...
export default SubjectExamQuestionView;
